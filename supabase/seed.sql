...
insert into public.modules (id, minggu, judul, rilis, tentor_pj, koordinator, ringkasan, berkas_url) values
  ($ksp$mod-01$ksp$, 1, $ksp$Flowchart 1$ksp$, $ksp$2026-09-14$ksp$, array[$ksp$Sabrina$ksp$, $ksp$Eldha$ksp$]::text[], $ksp$Michelle$ksp$, $ksp$Simbol-simbol flowchart dan alur urut: terminal, proses, masukan dan keluaran, serta cara membaca diagram dari atas ke bawah.$ksp$, null),
  ($ksp$mod-02$ksp$, 2, $ksp$Flowchart 2$ksp$, $ksp$2026-09-21$ksp$, array[$ksp$Sabrina$ksp$, $ksp$Eldha$ksp$]::text[], $ksp$Michelle$ksp$, $ksp$Percabangan dan perulangan di flowchart: simbol keputusan, alur yang kembali ke atas, dan menelusuri diagram dengan tabel jejak.$ksp$, null),
  ($ksp$mod-03$ksp$, 3, $ksp$Penamaan, Tipe, Sekuens$ksp$, $ksp$2026-09-28$ksp$, array[$ksp$Boby$ksp$, $ksp$Kley$ksp$]::text[], $ksp$Kley$ksp$, $ksp$Aturan penamaan variabel, tipe data dasar di C, dan program sekuensial pertama dengan printf dan scanf.$ksp$, null),
  ($ksp$mod-04$ksp$, 4, $ksp$Pemilihan$ksp$, $ksp$2026-10-05$ksp$, array[$ksp$Dwi$ksp$, $ksp$Andrew$ksp$]::text[], $ksp$Kley$ksp$, $ksp$if, else if, else, dan switch — memilih jalur program berdasarkan kondisi.$ksp$, null),
  ($ksp$mod-05$ksp$, 5, $ksp$Perulangan 1$ksp$, $ksp$2026-10-12$ksp$, array[$ksp$Ardhya$ksp$, $ksp$Beto$ksp$]::text[], $ksp$Rena$ksp$, $ksp$for dan while: menghitung, menjumlahkan, dan menentukan kapan sebuah perulangan berhenti.$ksp$, null),
  ($ksp$mod-06$ksp$, 6, $ksp$Perulangan 2$ksp$, $ksp$2026-10-19$ksp$, array[$ksp$Doni$ksp$, $ksp$Rena$ksp$]::text[], $ksp$Rena$ksp$, $ksp$do-while, perulangan bersarang, serta break dan continue.$ksp$, null),
  ($ksp$mod-07$ksp$, 7, $ksp$Prosedur 1$ksp$, $ksp$2026-10-26$ksp$, array[$ksp$Richard$ksp$, $ksp$Petra$ksp$]::text[], $ksp$Richard$ksp$, $ksp$Memecah program menjadi prosedur: deklarasi, pemanggilan, dan parameter masukan.$ksp$, null),
  ($ksp$mod-08$ksp$, 8, $ksp$Prosedur 2$ksp$, $ksp$2026-11-02$ksp$, array[$ksp$Adit$ksp$, $ksp$Tristan$ksp$]::text[], $ksp$Richard$ksp$, $ksp$Parameter keluaran: kenapa nilai yang diubah di dalam prosedur tidak ikut kembali, dan cara memperbaikinya dengan pointer.$ksp$, null),
  ($ksp$mod-09$ksp$, 9, $ksp$Fungsi$ksp$, $ksp$2026-11-09$ksp$, array[$ksp$Nathan$ksp$, $ksp$Stella$ksp$]::text[], $ksp$Michelle$ksp$, $ksp$Fungsi yang mengembalikan nilai, return, dan kapan memilih fungsi daripada prosedur.$ksp$, null),
  ($ksp$mod-10$ksp$, 10, $ksp$Array$ksp$, $ksp$2026-11-16$ksp$, array[$ksp$Albert$ksp$, $ksp$Nadya$ksp$]::text[], $ksp$Audrey$ksp$, $ksp$Array satu dimensi: indeks, perulangan atas array, pencarian, dan nilai terbesar atau terkecil.$ksp$, null),
  ($ksp$mod-11$ksp$, 11, $ksp$Record$ksp$, $ksp$2026-11-23$ksp$, array[$ksp$Jolie$ksp$, $ksp$Epun$ksp$]::text[], $ksp$Audrey$ksp$, $ksp$struct sebagai record: mengelompokkan data yang saling berkaitan dan mengakses tiap field-nya.$ksp$, null),
  ($ksp$mod-12$ksp$, 12, $ksp$Array of Record$ksp$, $ksp$2026-11-30$ksp$, array[$ksp$Albert$ksp$, $ksp$Adit$ksp$]::text[], $ksp$Audrey$ksp$, $ksp$Menggabungkan keduanya: array berisi struct untuk data berbentuk tabel, seperti daftar nilai satu kelas.$ksp$, null);
